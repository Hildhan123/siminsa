...
<div class="row">
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            ...
            <div class="card-body">
                <form autocomplete="off" action="{{ route('organisasi.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="form-control-label">Title Jabatan</label>
                        <input class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Masukkan title jabatan ..." value="{{ old('title') }}">
                    ...
                    <div class="form-group" id="struk" style="display:block">
                        ...
                        <select id="jabatan1" name="pegawai_id" class="form-control selectpicker" data-live-search="true">
                            ...
                            @foreach ($pegawai as $index)
                                <option value="{{$index->id}}" @if(old('pegawai') == $index->id) selected @endif>{{$index->nama}}</option>    
                            @endforeach
                        </select>
                        @error('jabatan')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('order') is-invalid @enderror" name="order" placeholder="Masukkan order index ..." value="{{ old('index') }}">
