...
@section('title', 'Tambah Navigasi Kelurahan')
                    ...
                    <div class="card shadow h-100">
                        <div class="card-header border-0">
                            <div
                                ...
                                <div class="mb-3">
                                    <h2 class="mb-0">Tambah Navigasi</h2>
        ...
        <div class="col">
            <div class="card bg-secondary shadow h-100">
                <div class="card-header bg-white border-0">
                    <h3 class="mb-0">Tambah navbar</h3>
                </div>
                <div class="card-body">
                    <form autocomplete="off" action="{{ route('navbar.store') }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <select id="parent" name="parent" class="form-control selectpicker" data-live-search="true">
                                ...
                                @foreach ($parent as $index)
                                    <option value="{{ $index->id }}" @if (old('parent') == $index->id) selected @endif>
                                        {{ $index->title }}</option>
                                @endforeach
                            </select>
                            @error('parent')
                        ...
                        <div class="form-group">
                            <input name="type" type="radio" class="with-gap radioBtn" data-target-id="1" id="radio_1" value="1"@if(old('type') == 1 || old('type') == null) checked @endif>
                            <label for="radio_1">External Url</label>
                            <input name="type" type="radio" class="with-gap radioBtn" data-target-id="2" id="radio_2" value="2"@if(old('type') == 2) checked @endif>
                            <label for="radio_2">Site Link</label>
                            <input name="type" type="radio" class="with-gap radioBtn" data-target-id="3" id="radio_3" value="3"@if(old('type') == 3) checked @endif>
                            <label for="radio_3">Page</label>
                            <input name="type" type="radio" class="with-gap radioBtn" data-target-id="4" id="radio_4" value="4"@if(old('type') == 4) checked @endif>
                        ...
                        <div class="my-div me_1" data-target="1">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('tipe1') is-invalid @enderror" name="tipe1"
                                    placeholder="https://google.com" value="{{ old('tipe1') }}">
                                @error('tipe1')
                                    <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="my-div me_2" data-target="2" style="display: none;">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('tipe2') is-invalid @enderror" name="tipe2"
                                    placeholder="/contoh" value="{{ old('tipe2') }}">
                                @error('tipe2')
                                    <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="page" name="page" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    @php $urlPage = "/p/".$index->id."/".Str::slug($index->judul) @endphp
                                        <option value="{{$urlPage}}" @if (old('page') == $urlPage) selected @endif>
                                            {{ $index->judul }}</option>
                                    @endforeach
                                </select>
                                @error('page')
                            ...
                            <div class="form-group">
                                ...
                                <select id="modul" name="modul" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    @foreach ($modul as $index)
                                        <option value="/{{ $index->slug }}" @if (old('modul') == '/'.$index->slug) selected @endif>
                                            {{ $index->nama }}</option>
                                    @endforeach
                                </select>
                                @error('modul')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('order') is-invalid @enderror" name="order" placeholder="Masukkan order index ..." value="{{ old('index') }}">
