            ...
            <div class="card-body">
                ...
                <form action="{{ route('update-desa',['desa' => $desa]) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nama_kelurahan" type="name" id="nama_kelurahan" class="form-control form-control-alternative @error('nama_kelurahan') is-invalid @enderror" placeholder="Masukkan nama kelurahan" value="{{ old('nama_kelurahan',$desa->nama_kelurahan) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="alamat" id="alamat" class="form-control form-control-alternative @error('alamat') is-invalid @enderror" placeholder="Masukkan alamat" value="{{ old('alamat',$desa->alamat) }}">
                        @error('alamat')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input name="kodepos" type="number" id="kodepos" class="form-control form-control-alternative @error('kodepos') is-invalid @enderror" placeholder="Masukkan kodepos" value="{{ old('kodepos',$desa->kodepos) }}">
                        @error('kodepos')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input name="kontak" type="number" id="kontak" class="form-control form-control-alternative @error('kontak') is-invalid @enderror" placeholder="Masukkan kontak" value="{{ old('kontak',$desa->kontak) }}">
                        @error('kontak')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
