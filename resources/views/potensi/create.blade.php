...
@section('title', 'Tambah Potensi Kelurahan')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Potensi</h2>
                                <p class="mb-0 text-sm">Kelola Potensi Kelurahan</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route("potensi.index") }}" class="btn btn-success" title="Kembali"><i class="fas fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-header bg-white border-0">
                <h3 class="mb-0">Tambah Potensi</h3>
            </div>
            <div class="card-body">
                <form autocomplete="off" action="{{route('potensi.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
