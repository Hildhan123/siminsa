                    ...
                    <div class="card shadow h-100">
                        <div class="card-header border-0">
                            <div
                                ...
                                <div class="mb-3">
                                    <h2 class="mb-0">Edit Lembaga</h2>
                                    <p class="mb-0 text-sm">Kelola Lembaga</p>
                                </div>
                                <div class="mb-3">
                                    <a href="{{ route('lembaga.index') }}" class="btn btn-success" title="Kembali"><i
    ...
    <div class="row">
        <div class="col">
            <div class="card bg-secondary shadow h-100">
                ...
                <div class="card-body">
                    <form autocomplete="off" action="{{ route('lembaga.update',$lembaga->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-center">
                                <img onclick="$(this).siblings('.images').click()" class="mw-100 upload-image"
                                    style="max-height: 300px" @if ($lembaga->logo) src="{{$lembaga->logo}}" @else src="{{ asset('storage/upload.jpg') }}" @endif alt="">
                                <input accept="image/*" onchange="uploadImage(this)" type="file" name="logo"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('nama') is-invalid @enderror" name="nama"
                                placeholder="Masukkan nama ..." value="{{ $lembaga->nama }}">
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('singkatan') is-invalid @enderror" name="singkatan"
                                placeholder="Masukkan singkatan ..." value="{{ $lembaga->singkatan }}">
                            @error('singkatan')
                                <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control @error('dasar_hukum') is-invalid @enderror" name="dasar_hukum"
                                placeholder="Masukkan dasar hukum ..." value="{{ $lembaga->dasar_hukum }}">
                            @error('dasar_hukum')
                                <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control @error('alamat') is-invalid @enderror" name="alamat"
                                placeholder="Masukkan alamat ..." value="{{ $lembaga->alamat }}">
                            @error('alamat')
                                <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('profil') is-invalid @enderror" name="profil">{{ $lembaga->profil }}</textarea>
                            @error('profil')
                                <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('visi_misi') is-invalid @enderror" name="visi_misi">{{ $lembaga->visi_misi }}</textarea>
                            @error('visi_misi')
                                <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('tugas_dan_fungsi') is-invalid @enderror" name="tugas_dan_fungsi">{{ $lembaga->tugas_dan_fungsi }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('kepengurusan') is-invalid @enderror" name="kepengurusan">{{ $lembaga->kepengurusan }}</textarea>
                            @error('kepengurusan')
                                <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
