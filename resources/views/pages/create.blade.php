    ...
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-header bg-white border-0">
                <h3 class="mb-0">Tambah Pages</h3>
            </div>
            <div class="card-body">
                <form autocomplete="off" action="{{ route('pages.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label class="form-control-label">Nama Page</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label">Judul Page</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label">Konten Page</label>
