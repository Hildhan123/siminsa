                ...
                <form autocomplete="off" action="{{ route('berita.update', ["beritum" => $berita]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="text-center">
                            <img title="Klik untuk ganti gambar" onclick="$(this).siblings('.images').click()" class="mw-100 upload-image" style="max-height: 300px" src="{{ $berita->gambar ? $berita->gambar : asset('storage/upload.jpg') }}" alt="Gambar berita {{ $berita->judul }}">
