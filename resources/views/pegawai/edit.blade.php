...
@section('styles')
    ...
    <link href="{{ asset('css/selectbootstrap.css') }}" rel="stylesheet">
@endsection
                    ...
                    <div class="card shadow h-100">
                        <div class="card-header border-0">
                            <div
                                ...
                                <div class="mb-3">
                                    <h2 class="mb-0">Edit Perangkat Desa</h2>
    ...
    <div class="row">
        <div class="col">
            <div class="card bg-secondary shadow h-100">
                ...
                <div class="card-body">
                    <form autocomplete="off" action="{{ route('pegawai.update',$pegawai->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-center">
                                <img onclick="$(this).siblings('.images').click()" class="mw-100 upload-image"
                                    style="max-height: 300px" @if ($pegawai->photo) src="{{$pegawai->photo}}" @else src="{{ asset('storage/upload.jpg') }}" @endif alt="">
                        ...
                        <div class="form-group">
                            <input name="tipe_jabatan" type="radio" class="with-gap" id="radio_1" 
                            value="struktural" checked>
                        ...
                        <div class="form-group" id="struk" style="display:block">
                            ...
                            <select id="jabatan1" name="jabatan1" class="form-control selectpicker" data-live-search="true">
                                ...
                                @foreach ($organisasi as $index)
                                    <option value="{{ $index->title }}" @if ($pegawai->jabatan == $index->title) selected @endif>
                                        {{ $index->title }}</option>
                                @endforeach
                            </select>
                            @error('jabatan')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi">{{ $pegawai->deskripsi }}</textarea>
                            @error('deskripsi')
                                <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
